...
Alternativement, vous pouvez aussi utiliser l'image Docker suivante: `docker run -p 8888:8888 -v "$PWD":/home/jovyan jupyter/scipy-notebook:17aba6048f44` [Source de l'image](https://github.com/jupyter/docker-stacks). Celle-ci est à lancer depuis le root directory de ce projet. 
